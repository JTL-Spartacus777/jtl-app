            ...
            with st.spinner("Logic Engine Running..."):
                ...
                for p in roster_data:
                    players.append({
                        ...
                        "Sends": safe_int(p["Marches"]), "Inf_Cav": safe_int(p["Inf_Cav"]),
                        "Rec_Count": 0, "History": []
                    })
    ...
    if st.button("🧪 Auto-Generate 50 Test Users"):
        if admin_key == ADMIN_PASSWORD:
            with st.spinner("Generating Vikings..."):
                test_users = []
                for i in range(1, 31):
                    test_users.append([f"OnViking_{i}", "Online", "Online", random.randint(4, 6), random.randint(10k, 80k), random.randint(1,1200), random.randint(1,1200), random.randint(100000, 300000), random.randint(300000, 1000000), random.randint(100000, 500000), random.randint(0, 200000)])
                for i in range(1, 21):
                    test_users.append([f"OffViking_{i}", "Offline", "Offline", random.randint(4, 6), random.randint(10k, 80k), random.randint(1,1200), random.randint(1,1200), random.randint(100000, 300000), random.randint(300000, 1000000), random.randint(100000, 500000), random.randint(0, 200000)])
